...
export class Film {
  ...
  private getOnlyMovies(film){
    return film.Type === 'movie';
  }
  
  getMovies(){
    let moviesOnly = this.films.filter(this.getOnlyMovies);
    return moviesOnly;
  }
  ...
  private getSeriesOnly(film){
    return film.Type === 'series';
  }

  getSeries(){
    let seriesOnly = this.films.filter(this.getSeriesOnly);
    return seriesOnly;
  }

  private getComingSoonOnly(film){
    return film.ComingSoon;
  }

  getComingSoon(){
    let comingSoonOnly = this.films.filter(this.getComingSoonOnly);
    return comingSoonOnly;
  }
